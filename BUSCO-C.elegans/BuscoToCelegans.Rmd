...
ggplot(LangeCelegans,aes(Percentcov))+geom_histogram(binwidth = 5)+ylim(0,110)+labs(title = "Laing Allinged to C.elegans Busco Proteins", subtitle = paste("CoverageThreshold =",LangeCelegansCV))

ggplot(LangBusco,aes(Percentcov))+geom_histogram(binwidth = 5)+ylim(0,110) +labs(title = "Laing Allinged to Busco Proteins",subtitle = paste("CoverageThreshold =",LangBuscoCV))

ggplot(LangeCelegansMoreSensative,aes(Percentcov))+geom_histogram(binwidth = 5)+ylim(0,110) + labs(title = "Laing Allinged to C.elegans Busco Proteins Using More Sensative",subtitle = paste("CoverageThreshold =",LangeCelegansMoreSensativeCV))
...
ggplot(LangeCelegans,aes(x=1,y=Percentcov))+geom_violin(alpha=0.2)+coord_flip()+geom_jitter(shape=16,size=0.4) + labs(title = "Laing Allinged to C.elegans Busco Proteins",subtitle = paste("CoverageThreshold =",LangeCelegansCV))

ggplot(LangBusco,aes(x=1,y=Percentcov))+geom_violin(alpha=0.2)+coord_flip()+geom_jitter(shape=16,size=0.4) + labs(title = "Laing Allinged to Busco Proteins",subtitle = paste("CoverageThreshold =",LangBuscoCV))

ggplot(LangeCelegansMoreSensative,aes(x=1,y=Percentcov))+geom_violin(alpha=0.2)+coord_flip()+geom_jitter(shape=16,size=0.4)+ labs(title = "Laing Allinged to C.elegans Busco Proteins Using More Sensative",subtitle = paste("CoverageThreshold =",LangeCelegansMoreSensativeCV))





ggplot(SchwarzeCelegans,aes(Percentcov))+geom_histogram(binwidth = 5)+ylim(0,80) + labs(title = "Schwarz Allinged to C.elegans Busco Proteins",subtitle = paste("CoverageThreshold =",SchwarzeCelegansCV))

ggplot(SchwarzBusco,aes(Percentcov))+geom_histogram(binwidth = 5)+ylim(0,80) + labs(title = "Schwarz Allinged to Busco Proteins",subtitle = paste("CoverageThreshold =",SchwarzBuscoCV))
...
ggplot(SchwarzeCelegans,aes(x=1,y=Percentcov))+geom_violin(alpha=0.2)+coord_flip()+geom_jitter(shape=16,size=0.4) + labs(title = "Schwarz Allinged to C.elegans Busco Proteins",subtitle = paste("CoverageThreshold =",SchwarzeCelegansCV))

ggplot(SchwarzBusco,aes(x=1,y=Percentcov))+geom_violin(alpha=0.2)+coord_flip()+geom_jitter(shape=16,size=0.4) + labs(title = "Schwarz Allinged to Busco Proteins",subtitle = paste("CoverageThreshold =",SchwarzBuscoCV))
