...
ggplot(SchwarzeCelegans,aes(Percentcov))+geom_histogram(binwidth = 5)+ylim(0,80)+ggtitle("Schwarz Allinged to C.elegans Busco Proteins")
...
ggplot(SchwarzeCelegans,aes(x=1,y=Percentcov))+geom_violin(alpha=0.2)+coord_flip()+geom_jitter(shape=16,size=0.4)+ggtitle("Schwarz Allinged to C.elegans Busco Proteins")
ggplot(SchwarzBusco,aes(x=1,y=Percentcov))+geom_violin(alpha=0.2)+coord_flip()+geom_jitter(shape=16,size=0.4)+ggtitle("Schwarz Allinged to Busco Proteins")
