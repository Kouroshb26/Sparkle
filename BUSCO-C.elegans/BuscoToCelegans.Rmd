...
ggplot(LangeCelegansMMseqs2,aes(Percentcov))+geom_histogram(binwidth = 5)+ylim(0,110) + labs(title = "Laing Aligned to C.elegans Busco Proteins Using MMseqs2",subtitle = paste("CoverageThreshold =",LangeCelegansMMseqs2CV))
